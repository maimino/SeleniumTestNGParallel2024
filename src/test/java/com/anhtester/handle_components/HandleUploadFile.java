...
public class HandleUploadFile extends BaseTest {
    ...
    public void testUploadFileWithSendKeys(){
        ...
        WebUI.setText( inputFileUpload, System.getProperty("user.dir") + "\\src\\test\\resources\\testdata\\totoro_1.jpg");
    ...
    public void testUploadFileWithRobotClass() {
        ...
        String filePath = SystemHelper.getCurrentDirectory() +  "src\\test\\resources\\testdata\\totoro_1.jpg";
        ...
        Assert.assertTrue(WebUI.checkElementExist(fileName), "Khong the tai len file");
    }
}
